...
function importDeserializeHelpers(context, client, sourceFile) {
    ...
    for (const [key, value] of deserializeDetails.entries()) {
        ...
        value.forEach((detail) => {
            var _a;
            deserializeMap.push(`"${detail.path}": { deserializer: ${(_a = detail.renamedDeserName) !== null && _a !== void 0 ? _a : detail.deserName}, expectedStatuses: ${detail.expectedStatusesExpression} }`);
        });
    }
...
//# sourceMappingURL=buildRestorePoller.js.map