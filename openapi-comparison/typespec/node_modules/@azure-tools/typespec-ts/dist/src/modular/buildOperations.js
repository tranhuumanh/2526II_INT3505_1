...
import { getDeserializePrivateFunction, getDeserializeHeadersPrivateFunction, getDeserializeExceptionHeadersPrivateFunction, getExpectedStatuses, getOperationFunction, getOperationOptionsName, getSendPrivateFunction, isLroOnlyOperation, isLroAndPagingOperation } from "./helpers/operationHelpers.js";
...
export function buildOperationFiles(dpgContext, clientMap, emitterOptions) {
    ...
    for (const [prefixKey, operations] of methodMap) {
        ...
        operations.forEach((op) => {
            ...
            const deserializeOperationDeclaration = getDeserializePrivateFunction(dpgContext, [prefixes, op]);
...
export function buildOperationOptions(context, method, sourceFile) {
    ...
    const bodyContentTypes = (_b = (_a = operation.operation.bodyParam) === null || _a === void 0 ? void 0 : _a.contentTypes) !== null && _b !== void 0 ? _b : [];
