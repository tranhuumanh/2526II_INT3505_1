...
function getModelSubpaths(emitterOptions) {
    ...
    const modelFiles = outputProject.getSourceFiles(path.join(emitterOptions.modularOptions.sourceRoot.replace(/\\/g, "/"), `models/**/*.ts`));
    ...
    for (const modelFile of modelFiles) {
        ...
        subpath.add(path.relative(emitterOptions.modularOptions.sourceRoot.replace(/\\/g, "/"), filepath));
    }
