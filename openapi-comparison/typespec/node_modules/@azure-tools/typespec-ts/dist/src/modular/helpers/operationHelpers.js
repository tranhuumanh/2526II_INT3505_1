...
export function getSerializationExpression(context, property, propertyPath, enableFlatten = true) {
    ...
    if (serializeFunctionName) {
        ...
        return serializeRequestValue(context, property.type, propertyFullName, !property.optional, getEncodeForModelProperty(context, property), getPropertySerializedName(property), propertyPath === "" ? true : false);
    }
}
