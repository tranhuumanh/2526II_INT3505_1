 ...
 */
export function addImportBySymbol(symbol, currentFile) {
    var _a;
    ...
    const modulePath = (_a = symbolMap.get(symbol)) === null || _a === void 0 ? void 0 : _a.getFilePath();
    if (!modulePath) {
        return;
    }
    ...
    const existing = currentFile.getImportDeclaration((i) => i.getModuleSpecifierValue() === relativeImportPath);
    if (existing) {
