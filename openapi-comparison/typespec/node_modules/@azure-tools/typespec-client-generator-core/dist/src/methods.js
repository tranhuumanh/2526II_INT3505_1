...
import { getAccess, getDisablePageable, getMarkAsPageable, getNextLinkVerb, getOverriddenClientMethod, getResponseAsBool, isInScope, listOperationsInOperationGroup, shouldGenerateConvenient, shouldGenerateProtocol, } from "./decorators.js";
        ...
        switch (step.kind) {
            ...
            case "pollingSuccessProperty": {
                return {
                    ...
                    responseModel: step.responseModel.kind === "Scalar"
                        ? diagnostics.pipe(getClientTypeWithDiagnostics(context, step.responseModel))
