import { DecoratorContext, DecoratorFunction, Enum, Interface, Model, ModelProperty, Namespace, Numeric, Operation, Scalar, Type, Union } from "@typespec/compiler";
...
import { ClientDefaultValueDecorator, DisablePageableDecorator, FlattenPropertyDecorator, HierarchyBuildingDecorator, MarkAsLroDecorator, MarkAsPageableDecorator, NextLinkVerbDecorator } from "../generated-defs/Azure.ClientGenerator.Core.Legacy.js";
import { AccessFlags, ClientInitializationOptions, ExternalTypeInfo, LanguageScopes, SdkClient, SdkOperationGroup, TCGCContext, UsageFlags } from "./interfaces.js";
 ...
 */
export declare function getAlternateType(context: TCGCContext, source: ModelProperty | Scalar | Model | Enum | Union): Type | ExternalTypeInfo | undefined;
...
export declare const $clientLocation: (context: DecoratorContext, source: Operation | ModelProperty, target: Interface | Namespace | Operation | string, scope?: LanguageScopes) => void;
/**
 * Gets the `Namespace`, `Interface` or name of client where an operation changes location to.
 */
export declare function getClientLocation(context: TCGCContext, input: Operation): Namespace | Interface | string | undefined;
/**
 * Gets the `Namespace`, `Interface`, `Operation` where a parameter changes location to.
 */
export declare function getClientLocation(context: TCGCContext, input: ModelProperty): Namespace | Interface | Operation | undefined;
export declare const $legacyHierarchyBuilding: HierarchyBuildingDecorator;
export declare function getLegacyHierarchyBuilding(context: TCGCContext, target: Model): Model | undefined;
export declare const $markAsLro: MarkAsLroDecorator;
export declare function getMarkAsLro(context: TCGCContext, entity: Operation): boolean;
export declare const $markAsPageable: MarkAsPageableDecorator;
export declare function getMarkAsPageable(context: TCGCContext, entity: Operation): MarkAsPageableInfo | undefined;
export interface MarkAsPageableInfo {
    itemsProperty: ModelProperty;
}
export declare const $disablePageable: DisablePageableDecorator;
export declare function getDisablePageable(context: TCGCContext, entity: Operation): boolean;
export declare const $nextLinkVerb: NextLinkVerbDecorator;
/**
 ...
 */
export declare function getNextLinkVerb(context: TCGCContext, entity: Operation): "GET" | "POST";
export declare const $clientDefaultValue: ClientDefaultValueDecorator;
/**
 ...
 */
export declare function getClientDefaultValue(context: TCGCContext, entity: ModelProperty): string | boolean | Numeric | undefined;
/**
 ...
 * @returns
 */
export declare function isInScope(context: TCGCContext, entity: Operation | ModelProperty): boolean;
export declare const clientOptionKey: symbol;
/**
 ...
 */
export declare const $clientOption: ClientOptionDecorator;
/**
 ...
 */
export declare function getClientOptionValue(context: TCGCContext, target: Operation, optionName: string): unknown | undefined;
/**
 * Known client option: omitSlashFromEmptyRoute
 * When set to true, operations with empty routes ("/") will have their path set to "".
 */
export declare function shouldOmitSlashFromEmptyRoute(context: TCGCContext, target: Operation): boolean;
export {};
