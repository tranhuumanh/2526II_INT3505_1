...
import { DateTimeKnownEncoding, Diagnostic, DurationKnownEncoding, EmitContext, Enum, Interface, IntrinsicScalarName, Model, ModelProperty, Namespace, Operation, PagingOperation, Program, Type, Union } from "@typespec/compiler";
