...
export declare const BrandedSdkEmitterOptions: {
    readonly "examples-dir": {
        readonly "examples-dir": {
            ...
            readonly description: "Specifies the directory where the emitter will look for example files. If the flag isn’t set, the emitter defaults to using an `examples` directory located at the project root.";
        };
    };
    readonly namespace: {
        readonly namespace: {
...
export declare const $lib: import("@typespec/compiler").TypeSpecLibrary<{
    ...
    "override-parameters-mismatch": {
        readonly default: import("@typespec/compiler").CallableMessage<["methodName", "checkParameter"]>;
    };
    ...
    "client-name-ineffective": {
        readonly default: import("@typespec/compiler").CallableMessage<["name"]>;
        readonly override: import("@typespec/compiler").CallableMessage<["name", "originalMethodName"]>;
    };
    "example-loading": {
    ...
    "unexpected-pageable-operation-return-type": {
        readonly default: "The response object for the pageable operation is either not a paging model, or is not correctly decorated with @nextLink and @pageItems.";
    };
    ...
    "client-location-conflict": {
        ...
        readonly operationToOperation: "`@clientLocation` cannot be used to move an operation to another operation. Operations can only be moved to interfaces or namespaces.";
        readonly modelPropertyToClientInitialization: import("@typespec/compiler").CallableMessage<["parameterName"]>;
        readonly modelPropertyToString: "`@clientLocation` can only move model properties to interfaces or namespaces.";
    };
    ...
    "legacy-hierarchy-building-conflict": {
        readonly "property-missing": import("@typespec/compiler").CallableMessage<["childModel", "propertyName", "parentModel"]>;
        readonly "type-mismatch": import("@typespec/compiler").CallableMessage<["propertyName", "childModel", "parentModel"]>;
    };
    "legacy-hierarchy-building-circular-reference": {
        readonly default: "@hierarchyBuilding decorator causes recursive base type reference.";
    };
    "missing-scope": {
        readonly default: import("@typespec/compiler").CallableMessage<["decoratorName"]>;
    };
    "required-parameter-scoped-out": {
        readonly default: import("@typespec/compiler").CallableMessage<["paramName", "scope"]>;
    };
    "external-library-version-mismatch": {
        readonly default: import("@typespec/compiler").CallableMessage<["libraryName", "versionA", "versionB"]>;
    };
    "external-type-on-model-property": {
        readonly default: "@alternateType with external type information cannot be applied to model properties. Please apply it to the type definition itself (Scalar, Model, Enum, or Union) instead.";
    };
