...
import { BooleanLiteral, Diagnostic, Enum, Interface, Model, ModelProperty, Namespace, NumericLiteral, Operation, Program, StringLiteral, Type, Union, Value } from "@typespec/compiler";
import { Authentication, HttpOperation, HttpOperationResponseContent, HttpPayloadBody, HttpServer } from "@typespec/http";
import { DecoratorInfo, ExternalTypeInfo, SdkBuiltInType, SdkClient, SdkClientType, SdkEnumType, SdkHeaderParameter, SdkMethodParameter, SdkOperationGroup, SdkServiceOperation, SdkType, TCGCContext } from "./interfaces.js";
...
export declare const overrideKey: symbol;
export declare const usageKey: symbol;
export declare const legacyHierarchyBuildingKey: symbol;
 ...
 */
export declare function parseScopes(scope?: string): [string[]?, string[]?];
/**
 *
 ...
 */
export declare function findServiceForOperation(services: Namespace[], operation: Operation): Namespace;
/**
 *
 * @param context
 ...
 */
export declare function updateWithApiVersionInformation(context: TCGCContext, type: ModelProperty, client?: SdkClient | SdkOperationGroup, operation?: Operation): {
...
export declare function isAcceptHeader(param: SdkHeaderParameter): boolean;
export declare function isContentTypeHeader(param: SdkHeaderParameter): boolean;
 ...
 * @param context
 */
export declare function createGeneratedName(context: TCGCContext, type: Interface | Namespace | Operation, suffix: string): string;
...
export declare function filterPreviewVersion(context: TCGCContext, sdkVersionsEnum: SdkEnumType, defaultApiVersion: string): void;
 ...
 * @returns
 */
export declare function getHttpBodyType(httpBody: HttpPayloadBody): Type;
export declare function isOnClient(context: TCGCContext, type: ModelProperty, operation?: Operation, versioning?: boolean): boolean;
export declare function getCorrespondingClientParam(context: TCGCContext, type: ModelProperty, operation: Operation): SdkMethodParameter | undefined;
...
export declare function compareModelProperties(program: Program, modelPropA: ModelProperty | undefined, modelPropB: ModelProperty | undefined): boolean;
 ...
 */
export declare function findEntriesWithTarget<TSource extends Type, TTarget>(context: TCGCContext, stateKey: symbol, targetValue: TTarget, sourceKind?: TSource["kind"]): TSource[];
/**
 ...
 */
export declare function getTcgcLroMetadata<TServiceOperation extends SdkServiceOperation>(context: TCGCContext, operation: Operation, client: SdkClientType<TServiceOperation>): LroMetadata | undefined;
export declare function getActualClientType(client: SdkClient | SdkOperationGroup): Namespace | Interface;
export declare function isSameServers(left: HttpServer[], right: HttpServer[]): boolean;
export declare function isSameAuth(left: Authentication, right: Authentication): boolean;
export declare function isTypeNeedsHandling(context: TCGCContext, type: Type): boolean;
export declare function listOrphanTypes(context: TCGCContext): (Model | Enum | Union)[];
export {};
