...
exports.commonPackageDependencies = void 0;
exports.getPackageCommonInfo = getPackageCommonInfo;
exports.getCommonPackageDevDependencies = getCommonPackageDevDependencies;
exports.resolveWarpExports = resolveWarpExports;
exports.getTshyConfig = getTshyConfig;
exports.getCommonPackageScripts = getCommonPackageScripts;
/**
 * Common package.json config for a package.
 */
function getPackageCommonInfo(config) {
...
exports.commonPackageDependencies = {
    tslib: "^2.6.2"
};
function getCommonPackageDevDependencies(config) {
    return {
        "@types/node": "^20.0.0",
        eslint: "^9.9.0",
        typescript: "~5.8.2",
...
function getCjsEntrypointInformation({ name, nameWithoutScope, moduleKind, withTests, withSamples }) {
    ...
    const types = withTests || withSamples
        ? `./types/src/${nameWithoutScope !== null && nameWithoutScope !== void 0 ? nameWithoutScope : name}.d.ts`
        : `./types/${nameWithoutScope !== null && nameWithoutScope !== void 0 ? nameWithoutScope : name}.d.ts`;
    const main = withTests || withSamples ? "dist/src/index.js" : "dist/index.js";
    return {
        main,
        module: withTests || withSamples
 ...
 */
function resolveWarpExports(sourceExports) {
    const exports = {};
    const allExports = {
...
function getCommonPackageScripts() {
    return {
...
//# sourceMappingURL=packageCommon.js.map