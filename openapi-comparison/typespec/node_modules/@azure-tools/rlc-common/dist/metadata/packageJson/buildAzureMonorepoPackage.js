...
exports.buildAzureMonorepoPackage = buildAzureMonorepoPackage;
exports.getAzureMonorepoDependencies = getAzureMonorepoDependencies;
 ...
 */
function buildAzureMonorepoPackage(config) {
    const packageInfo = {
 ...
 */
function getAzureMonorepoDependencies(config) {
...
function getAzureMonorepoPackageInfo(config) {
    ...
    return {
        ...commonPackageInfo,
        ...(0, azurePackageCommon_js_1.getAzureCommonPackageInfo)(config),
...
function getSampleMetadata({ name, version, withSamples }) {
    if (!withSamples) {
        return {};
    }
