...
exports.getAzureCommonPackageInfo = getAzureCommonPackageInfo;
exports.getAzurePackageDependencies = getAzurePackageDependencies;
exports.getAzurePackageDevDependencies = getAzurePackageDevDependencies;
const packageCommon_js_1 = require("./packageCommon.js");
/**
 * Build the common package.json config for an Azure package.
 */
function getAzureCommonPackageInfo(config) {
    return {
...
function getAzurePackageDevDependencies(config) {
...
//# sourceMappingURL=azurePackageCommon.js.map