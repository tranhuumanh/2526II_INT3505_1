...
function shouldGenerateTestConfig(model) {
    ...
    return !(model.options?.generateMetadata === false ||
...
export function buildTestMainTsConfig(model) {
    if (!shouldGenerateTestConfig(model)) {
        return;
    }
