...
import { getAzureCommonPackageInfo } from "./azurePackageCommon.js";
 ...
 */
export function buildAzureMonorepoPackage(config) {
    const packageInfo = {
 ...
 */
export function getAzureMonorepoDependencies(config) {
