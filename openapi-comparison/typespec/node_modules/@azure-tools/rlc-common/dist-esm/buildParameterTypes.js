...
export function buildBodyTypeAlias(parameters, partialBodyTypeNames) {
    const bodyParameters = parameters.body;
    if (!bodyParameters ||
        !bodyParameters?.body ||
        !bodyParameters?.body.length) {
