export declare const $lib: import("@typespec/compiler").TypeSpecLibrary<{
    ...
    "lro-status-monitor-invalid-result-property-type": {
        readonly default: import("@typespec/compiler").CallableMessage<["propertyName", "typeName"]>;
    };
